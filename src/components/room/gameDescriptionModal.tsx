 ...
 */
export function GameDescriptionModal({
	isOpen,
	onClose,
	gameType,
}: GameDescriptionModalProps) {
	// ERROR HUNTER用の説明
					...
					<div className="space-y-3">
						...
						<ol className={eh.list()}>
							<li className={eh.listItem()}>
								...
								<span>
									<strong className="text-brand-900">待機フェーズ</strong> -
									ホストがスタートを押したら、全員で画面を凝視！
									<br />
							...
							<li className={eh.listItem()}>
								...
								<span>
									<strong className="text-red-400">エラー出現！</strong> -
									突然、画面にエラーダイアログが出現する！
								</span>
							</li>
							<li className={eh.listItem()}>
								...
								<span>
									<strong className="text-brand-900">早い者勝ち！</strong> -
									「×」ボタンを最速でクリックした人が勝者！
									<br />
									<span className="text-red-400 text-xs font-semibold">
										※ フライング（エラー出現前のクリック）は無効です
									</span>
								</span>
							</li>
							<li className={eh.listItem()}>
								...
								<span>
									<strong className="text-green-400">勝者発表！</strong> -
									一番早くクリックした人の名前が表示されます
								</span>
							</li>
						</ol>
					</div>
					...
					<div className="space-y-2">
						...
						<div className={eh.victoryBox()}>
							<p className={eh.victoryText()}>
								エラーダイアログの「×」ボタンを
								<span className="text-base text-red-400">最初にクリック</span>
								した人が勝利！
							</p>
					...
					<div className="space-y-2">
						...
						<ul className={eh.tipsList()}>
							<li className={eh.listItem()}>
								...
								<span>
									画面の中央に集中して、エラーが出現する瞬間を見逃さないように！
								</span>
							</li>
							<li className={eh.listItem()}>
								<span className="mr-2">•</span>
								<span>
									マウスカーソルを画面中央付近に置いておくと、素早く反応できます
								</span>
							</li>
							<li className={eh.listItem()}>
								<span className="mr-2">•</span>
								<span className="text-red-400 font-semibold">
									フライングは無効！待機バーが消えてからクリックしましょう
								</span>
							</li>
						</ul>
					</div>
					...
					<div className={nh.content()}>
						...
						<div className="space-y-3">
							<Typography variant="h3" className={nh.sectionTitle()}>
								<div className={nh.sectionDot()} />📋 ゲームの流れ
							</Typography>
							<ol className={nh.flowList()}>
								...
								<li className={nh.listItem()}>
									...
									<span>
										<strong className="text-white">意志の開示 (RESULT)</strong>
										<br />
						...
						<div className="space-y-3">
							<Typography variant="h3" className={nh.sectionTitle()}>
								<div className={nh.sectionDot()} />■ REWARD SYSTEM /
								ポイント配当
							</Typography>
							<RewardSystem
								isHost={false}
						...
						<div className="space-y-2">
							<Typography variant="h3" className={nh.sectionTitle()}>
								<div className={nh.sectionDot()} />💡 プレイのコツ
							</Typography>
					...
					<div className={ss.content()}>
						...
						<div className={ss.previewArea()}>
							...
							<div className="relative z-10 grid grid-cols-2 gap-4">
								...
								<div
									...
									style={{
										border: `1px solid ${ROLE_META.TYPIST.border}`,
										background: ROLE_META.TYPIST.bg,
									}}
								>
									<h4
										className="text-xs font-bold tracking-wider"
										style={{ color: ROLE_META.TYPIST.text }}
									>
										タイピスト
									</h4>
											...
											<div className="relative flex items-center gap-1.5 shrink-0">
												...
												<div
													...
													style={{
														...
														boxShadow: `0 0 4px ${BULLET_COLOR}`,
													}}
												/>
											</div>
											<span className="text-xs font-medium text-brand-600">
								...
								<div
									className="rounded-lg p-5 flex flex-col gap-4 items-center"
									style={{
										border: `1px solid ${ROLE_META.SHOOTER.border}`,
										background: ROLE_META.SHOOTER.bg,
									}}
								>
									<h4
										className="text-xs font-bold tracking-wider"
										style={{ color: ROLE_META.SHOOTER.text }}
									>
										シューター
									</h4>
									<div className="flex flex-col gap-4 w-full">
						...
						<div className="space-y-3">
							...
							<ol className={ss.flowList()}>
								<li className={ss.listItem()}>
									...
									<span>
										<strong className="text-white">役割選択</strong> -
										シューター（照準）とタイピスト（タイピング）の2役
									</span>
								</li>
								<li className={ss.listItem()}>
									<span className={ss.bullet()}>2.</span>
									<span>
										<strong className="text-white">タイピングで弾発射</strong> -
										タイピストが1文字打つごとに、シューターの照準方向へ弾が飛ぶ
									</span>
								</li>
								<li className={ss.listItem()}>
									<span className={ss.bullet()}>3.</span>
									<span>
										<strong className="text-white">隕石を破壊</strong> -
										弾が隕石に当たるとダメージ。HP分当てると破壊
									</span>
								</li>
								<li className={ss.listItem()}>
									<span className={ss.bullet()}>4.</span>
									<span>
										<strong className="text-white">星を守る</strong> -
										隕石が星に接触すると星のHP減少。90秒耐えればクリア！
									</span>
								</li>
							</ol>
						</div>
						...
						<div className="space-y-2">
							...
							<div className={ss.victoryBox()}>
								<p>
									<strong className="text-green-400">クリア</strong> -
									90秒間、星のHPを保ちながら隕石を破壊し続ける
								</p>
								<p>
									<strong className="text-red-400">ゲームオーバー</strong> -
									隕石が星に直撃して星のHPが0になる
								</p>
							</div>
						</div>
						...
						<div className="space-y-2">
							...
							<ul className={ss.tipsList()}>
								<li className={ss.listItem()}>
									...
									<span>
										シューターは照準を隕石に合わせ、タイピストは正確にタイピング
									</span>
								</li>
								<li className={ss.listItem()}>
									<span className={ss.tipsBullet()}>•</span>
