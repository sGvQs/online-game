...
export const gameSelection = tv({
	slots: {
		...
		gameIcon:
			"relative z-10 flex items-center justify-center shrink-0 w-12 h-12 group-hover:scale-110 transition-transform duration-300",
		...
		// Background effects
		nullHandBg:
			"absolute inset-0 bg-[#FF4444]/5 group-hover:bg-[#FF4444]/10 transition-colors",
		starShieldBg:
			"absolute inset-0 bg-brand-500/5 group-hover:bg-brand-500/10 transition-colors",
	},
});
