...
export const lpHero = tv({
    slots: {
        ...
        specBadgeTitle: 'text-[11px] font-bold text-brand-400 tracking-wide font-dot-gothic-16',
        specBadgeSub: 'text-[9px] text-brand-600 mt-0.5 font-dot-gothic-16',
        ...
        catchCopy: 'mt-8 text-brand-700 text-base md:text-lg max-w-md leading-relaxed font-dot-gothic-16',
        ctaButton: [
            'mt-10 group relative inline-flex items-center gap-2.5 px-8 py-3.5 rounded-full',
        ...
        scrollLabel: 'text-[10px] tracking-[0.3em] text-brand-600 font-dot-gothic-16',
