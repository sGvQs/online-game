...
export const errorHunterDemo = tv({
    slots: {
        ...
        errorCard: 'absolute translate-x-[-50%] translate-y-[-50%] z-10 animate-[win95-appear_0.15s_ease-out]',
        overlay: 'absolute inset-0 flex items-center justify-center z-20 bg-black/30',
    },
})
