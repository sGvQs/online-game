                        ...
                        <div key={item.title} className={cn(
                            ...
                            <div className="flex items-center justify-between mb-1">
                                ...
                                <div className={cn(
                                    ...
                                    isMyTarget ? (isHost ? "border-[#FF4444]/50 shadow-[0_0_10px_rgba(255,68,68,0.2)]" : "border-[#44FFFF]/50 shadow-[0_0_10px_rgba(68,255,255,0.2)]") : "border-white/5"
                                )}>
                                    <span className={cn(
                                        "text-[8px] font-bold uppercase tracking-tighter",
                                        isMyTarget ? (isHost ? "text-[#FF4444] animate-pulse" : "text-[#44FFFF] animate-pulse") : "text-white/90"
                                    )}>
                                        {item.target}
                                    </span>
