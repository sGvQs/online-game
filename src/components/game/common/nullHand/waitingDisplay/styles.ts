...
export const waitingDisplay = tv({
	slots: {
		...
		bgHand:
			"absolute inset-0 flex items-center justify-center opacity-20 pointer-events-none filter blur-[2px]",
		content:
			"flex-1 flex flex-col items-center justify-center relative z-10 text-center",
		pulse: "animate-pulse",
		engLabel:
		...
		subText: "text-gray-600 text-xs font-sans tracking-[0.2em] uppercase",
	},
});
