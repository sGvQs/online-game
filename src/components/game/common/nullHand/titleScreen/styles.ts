...
export const titleScreen = tv({
  slots: {
    container: [
      'bg-black', 'h-screen', 'w-screen', 'font-sans', 'text-white',
      'overflow-hidden', 'flex', 'items-center', 'justify-center', 'p-4', 'md:p-8',
    ],
    titleGrid: [
      'grid', 'grid-cols-1 md:grid-cols-2', 'gap-6', 'w-full', 'max-w-6xl',
    ],
    menuBox: [
      'border-[6px]', 'border-[#FF4444]', 'bg-black', 'p-6',
      'flex', 'flex-col', 'justify-start', 'min-h-[300px]',
    ],
    menuItem: [
      'text-2xl', 'font-bold', 'py-2', 'px-2', 'mb-1',
      'cursor-pointer', 'transition-all', 'duration-200',
      'uppercase', 'tracking-[0.3em]', 'text-white',
      'border-2', 'border-transparent', 'hover:border-[#FF4444]',
    ],
    ...
    infoBox: [
      'col-span-1 md:col-span-2', 'border-[6px]', 'border-[#FF4444]', 'bg-black',
      'p-8', 'min-h-[150px]', 'flex', 'items-center', 'justify-center', 'text-center',
    ],
