...
export const roleSelectionScreen = tv({
    slots: {
        ...
        difficultyCard: 'rounded-2xl p-5 flex flex-col gap-3 transition-opacity bg-white/3 border border-white/8',
        difficultyCardTitle: 'text-[11px] font-cherry-bomb-one text-[rgba(129,140,248,0.6)]',
        difficultyButton: [
        ...
        rateLabel: 'text-[10px] shrink-0 tabular-nums font-dot-gothic-16 [color:var(--diff-rate-color)]',
        successHint: 'text-[10px] leading-relaxed mt-1 font-cherry-bomb-one [color:var(--diff-hint-color)] opacity-70',
        ...
        roleTitle: 'text-base font-bold font-cherry-bomb-one [color:var(--role-title-color)]',
        roleDescription: 'text-[11px] leading-snug mb-1 font-dot-gothic-16 [color:var(--role-desc-color)]',
        roleDetail: 'text-[10px] leading-relaxed font-dot-gothic-16 [color:var(--role-detail-color)]',
        statusPanel: 'rounded-2xl px-5 py-4 [background:var(--status-panel-bg)] [border:var(--status-panel-border)]',
        statusMessage: 'text-sm mb-3 min-h-5 font-cherry-bomb-one [color:var(--status-message-color)]',
        statusDot: 'w-2 h-2 rounded-full shrink-0 [background-color:var(--status-dot-color)]',
        playerName: 'text-sm flex-1 truncate font-dot-gothic-16 [color:var(--player-name-color)]',
