...
import { SPECIAL_ATTACK_LEVEL_PARAMS, type SpecialAttackLevel } from '@/constants/starShieldGame/skillConfig'
    ...
    useEffect(() => {
        ...
        function spawnWave(_waveIndex: number) {
            ...
            for (let i = 0; i < displayCount; i++) {
                ...
                bullets.push({ x: DINO_X + 18, y: ORIGIN_Y, vx: Math.cos(rad) * SPEED, vy: Math.sin(rad) * SPEED, alpha: 0.95 })
            }
        }
        ...
        <div className="relative mt-2 h-[88px] rounded-xl overflow-hidden border border-white/[0.07] bg-black/35">
            ...
            <div className="absolute bottom-1.5 left-10 flex items-center gap-1.5">
                <span
                    ...
                    style={{ '--bc': bulletColor, '--bc-shadow': `${bulletColor}99` } as CSSProperties}
                />
