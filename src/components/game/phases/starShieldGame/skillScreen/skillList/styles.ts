...
export const skillRowStyles = tv({
	slots: {
		...
		levelBarFill:
			"h-full rounded-full transition-all duration-700 w-(--progress) bg-(--bar-color)",
		levelText:
			"text-[10px] tracking-wider text-white/40 font-dot-gothic-16 shrink-0 w-8 text-right",
		badgeNotOwned:
			"text-[10px] text-white/40 shrink-0 font-dot-gothic-16 border border-white/20 bg-white/5 px-2 py-0.5 rounded tracking-widest",
		badgeMaxed:
			"text-[10px] text-amber-300 shrink-0 font-dot-gothic-16 border border-amber-500/30 bg-amber-500/10 px-2 py-0.5 rounded tracking-widest",
		badgeLevel:
			"text-[10px] text-white/70 shrink-0 font-dot-gothic-16 border border-white/10 bg-white/5 px-2 py-0.5 rounded tracking-widest",
	},
});
