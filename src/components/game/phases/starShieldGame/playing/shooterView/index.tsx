...
function ContactExplosionEffect({ pos, onComplete }: { pos: { x: number; y: number }; onComplete: () => void }) {
    ...
    return (
        ...
        >
            <motion.div className={styles.explosionCore()}
            ...
            >
                <div className="relative w-full h-full">
                    <Image src={ICONS.FIRE} alt="" fill className={styles.explosionImage()} />
                </div>
            </motion.div>
            <motion.div className={styles.explosionFlash()}
        ...
        return (
            ...
            >
                <div className="relative w-32 h-32">
                    <Image src={ICONS.FIRE} alt="" fill className={styles.explosionSmall()} />
                </div>
            </motion.div>
        )
    }
