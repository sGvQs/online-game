...
function TypingDisplay({
	...
	return (
		<div className="flex flex-col items-center gap-6">
			...
			>
				<div className="text-brand-500/60 text-xs tracking-widest mb-2">
					DIALOGUE
				</div>
			...
			<div className="w-64 h-1 bg-white/10 rounded-full overflow-hidden">
				<motion.div
					...
					animate={{
						width: `${romaji.length > 0 ? (charIndex / romaji.length) * 100 : 0}%`,
					}}
	...
	return (
		...
		>
			...
			<AuroraGlow
				...
				opacity={0.2}
				blur={48}
				gradient={AURORA_GRADIENT_TYPIST}
			/>
			...
			<div className="w-full shrink-0 flex flex-col items-center gap-2 py-4 z-20 mt-10">
				<Typography
					...
					className={typistView().scoreLabel()}
				>
					いんせきをかはいしたかず
				</Typography>
				<div className="flex items-center gap-3">
					...
					>
						<Typography
							...
							as="span"
							font="cherry-bomb-one"
							className={typistView().scoreValue()}
						>
							{score.destroyed}
						</Typography>
					</motion.div>
