...
export const gameOverPhase = tv({
  slots: {
    ...
    rankContainer: 'flex items-center justify-center gap-8 text-4xl font-sans font-bold',
    rankOld: 'text-gray-500',
    rankArrow: 'text-white',
    rankNew: 'text-[#FF4444] text-5xl',
    pointsContainer: 'mt-4 flex items-center justify-center gap-4 text-xl font-sans',
