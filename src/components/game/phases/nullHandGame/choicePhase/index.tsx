						...
						>
							<div className="flex justify-center items-center gap-2 text-gray-400 text-xs">
								<div
									className={cn(
										...
										isCurrentHost ? "bg-[#44FFFF]" : "bg-[#FF4444]",
									)}
								/>
							...
							{isCurrentHost ? (
								<Typography
									...
									as="p"
									font="sans"
									className="flex justify-center items-center gap-2 text-gray-400 animate-pulse"
								>
									上記のデータはゲストに公開されています...
								</Typography>
							) : (
						...
						>
							...
							>
								<div className="flex items-end gap-2">
									<PlayerFaceIcon
										faceIcon={hostFaceIcon}
										customSrc={hostCustomIconSrc}
										size="sm"
									/>
									<div
										className="text-xs font-black tracking-[0.3em] [color:var(--choice-color)]"
										style={{
											["--choice-color" as string]: isCurrentHost
												? userColor || "#FF4444"
												: "#FF4444",
										}}
									>
