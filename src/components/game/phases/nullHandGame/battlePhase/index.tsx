...
export function BattlePhase({
	...
	// 自分が既に手を送信済みか判定
	const hasSubmitted = jankenEvent.guestHands.some(
		(gh) => gh.userId === currentUserId,
	);
						...
						<div className="inline-flex flex-col items-start text-gray-400 text-xs text-left">
							<div className="flex items-center gap-2 leading-relaxed">
								...
								<span>
									...
									の確率で
									<span className="text-[#44FFFF] text-sm font-bold ml-1">
										SYSTEM SELECTION
									</span>
									を選んでいます
								</span>
						...
						<div className="absolute inset-0 flex items-center justify-between pointer-events-none px-4">
							<div className="flex flex-col items-center gap-1">
								<div className="w-32 h-32 flex items-center justify-center">
									{realHand && (
										<Hand3D handType={realHand} revealed={true} size="small" />
									)}
								</div>
								<Typography
									variant="caption"
									as="p"
									font="sans"
									className="text-[#44FFFF] font-bold text-center -translate-y-8"
								>
									SYSTEM SELECTION
								</Typography>
							</div>
							<div className="flex flex-col items-center gap-1">
								<div className="w-32 h-32 flex items-center justify-center">
									{bluffHand && (
										<Hand3D handType={bluffHand} revealed={true} size="small" />
									)}
								</div>
								<div className="h-8" />
							</div>
					...
					<div className="inline-flex flex-col items-start text-gray-400 text-xs text-left">
						{hostStats && (
							<div className="flex items-center leading-relaxed">
								...
								<span className="text-[#44FFFF] font-bold ml-1">
									SYSTEM SELECTIONを選ぶ確率{" "}
								</span>
								...
								<span className="text-gray-400 text-[10px] ml-1 animate-pulse">
									(この情報は公開されています)
								</span>
							</div>
						)}
							...
							<span>
								...
								<span className="text-white font-bold ml-1">
									...
									{getHandDisplayWithEmoji(
										jankenEvent.finalHostHand as HandType,
									)}
								</span>
							</span>
						</div>
