...
export const starShieldGame = tv({
	slots: {
		...
		container:
			"relative min-h-screen overflow-hidden flex flex-col items-center justify-center",

		// 星背景
		starsLayer:
			"min-h-screen flex flex-col items-center justify-center p-8 bg-transparent",

		// タイトル画面グリッド
		titleGrid:
			"relative z-10 w-full max-w-5xl mx-auto px-6 grid grid-cols-[1fr_auto] gap-12 items-center",
		...
		menuItemReady:
			"text-brand-500 pointer-events-none drop-shadow-[0_0_10px_rgba(129,140,248,0.8)]",
		...
		difficultyLabel:
			"text-brand-500/60 text-xs tracking-[0.4em] uppercase mb-3",
		...
		difficultyActive:
			"border-brand-500 text-brand-500 bg-brand-500/10 shadow-[0_0_8px_rgba(129,140,248,0.4)]",
		difficultyInactive:
		...
		playerPanelTitle:
			"text-brand-500/60 text-xs tracking-[0.4em] uppercase mb-1",
		...
		divider:
			"w-px bg-linear-to-b from-transparent via-brand-500/40 to-transparent self-stretch",
	},
});
