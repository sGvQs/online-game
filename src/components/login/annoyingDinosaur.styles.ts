...
export const rotateFlowStyles = tv({
	slots: {
		...
		imageWrapper: "relative w-14 h-14 sm:w-16 sm:h-16 shrink-0",
		bubble:
			"shrink-0 mb-2 px-2.5 py-1.5 rounded-xl border border-white bg-white text-black text-[10px] font-medium shadow-sm max-w-[400px]",
	},
});
...
export const suckedInStyles = tv({
	slots: {
		...
		imageWrapper: "relative w-14 h-14 sm:w-16 sm:h-16 shrink-0",
		bubble:
			"shrink-0 mb-1 px-2.5 py-1.5 rounded-xl border border-white bg-white text-black text-[10px] font-medium shadow-sm",
	},
});
