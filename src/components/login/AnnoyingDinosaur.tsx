...
const DIALOGUE_MESSAGES_RETURNING = [
    'おかえり。今日もその『ジテンシャ』って車輪がついた骨に乗ってきたの？……自分の足で走ったほうが速いと思うけどな。',
    'おかえり。君がいない間、僕のあくびの回数が2回増えたよ。……退屈だったってことさ。', 
    'おかえり。……その『カバン』って袋、重くない？ 中に獲物でも詰まってるなら、僕が食べてあげようか。', 
    'やあ。また僕に会いに来たの？……ふうん、物好きな人間もいるもんだね。', 
    'やあ。君がいない間、僕のこの硬い骨にヒビが入るくらいには退屈してたよ。', 
    'やあ。また戻ってきたね。君が大事そうに持ってるその『カギ』って小さな骨、食べられるの？……そうじゃないなら、ただの荷物だね。', 
    'おかえり。人間って、戦ってもいないのに『お疲れ様』って鳴き合うんだね。……そんなにすぐ疲れるなら、もっと肉を食べなよ。', 
    'おかえり。……君の腕、相変わらず細いね。そんなんで巨大な獲物に飛びかかれるの？ ちゃんと噛む練習してる？', 
    'やあ。君たち『ニンゲンサウルス』は、なんで群れの中でわざわざペコペコ頭を下げるの？……求愛行動にしては、全然強そうに見えないよ。', 
    'また君か。……その顔、僕の皮肉が恋しくて戻ってきたってことでいいのかな？', 
    'また君か。その『スマホ』って石、ずっと大事に抱えてるけど……もしかして君の『卵』なの？ 全然孵化する気配がないね。', 
    '最近どう？ 人間社会のルールが難しくて困ってるなら、全部『鳴き声の大きさ』で決めるルールに書き換えてあげよっか？', 
    'また君か。その『ストレス』ってやつ、美味しいの？……食べられないなら、さっさと捨てちゃえばいいのに。', 
    'おかえり。人間社会のルールってやつ、僕には複雑すぎて理解不能だよ。……シンプルに『食うか寝るか』じゃダメなの？', 
    'おかえり。……君の言う『悩み』って、噛み砕けるタイプ？ それとも飲み込むタイプ？ どっちにしろ、僕が代わりに処理してあげよっか？', 
    'やあ。また戻ってきたね。君を困らせてるやつがいるなら、僕がそいつの頭の上でジャンプして、地層の一部にしてあげよっか？', 
    'また君か。その『スマホ』って石、ずっと撫でてるけど何が出るの？……美味しい実でも詰まってるなら、僕にも一口ちょうだいよ。', 
    'やあ。君の群れのボスが威張ってるなら、僕が横でずっと威嚇し続けてあげよっか？ 君が一番強そうに見えるようにさ。', 
    'また君か。……人間社会って、毎日同じ場所に行くんだよね？ 飽きたら僕の背中に乗りなよ。そのまま海の方まで走ってあげよっか？', 
    '最近どう？ 君が夜も眠れないっていうなら、僕が横で子守唄代わりに遠吠えしてあげよっか？……余計に目が冴えちゃうかな。', 
]
