...
import { Geist, Geist_Mono, Zen_Maru_Gothic, DotGothic16, Kaisei_Opti, Yusei_Magic, Honk, Coral_Pixels, Sixtyfour_Convergence, Bitcount_Grid_Double_Ink, Rubik_Puddles } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="ja" suppressHydrationWarning>
      <body
        className={`${dotGothic16.variable} ${yuseiMagic.variable} ${kaiseiOpti.variable} ${zenMaruGothic.variable} ${geistSans.variable} ${geistMono.variable} ${honk.variable} ${coralPixels.variable} ${sixtyfourConvergence.variable} ${bitcountGridDoubleInk.variable} ${rubikPuddles.variable} antialiased`}
