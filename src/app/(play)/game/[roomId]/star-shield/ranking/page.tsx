...
export default async function StarShieldRankingPage({ params }: { params: Promise<{ roomId: string }> }) {
    ...
    const memberUserIds = room.users.map((u: RoomUserWithReadyStatus) => u.userId)
