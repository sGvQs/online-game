    ...
    return (
        <LegalPageLayout title="利用規約">
            <section className="space-y-2">
                <Typography variant="h2" className="text-base font-bold mt-6 first:mt-0">第1条（適用）</Typography>
            ...
            <section className="space-y-2">
                <Typography variant="h2" className="text-base font-bold mt-6">第2条（サービス概要）</Typography>
                <Typography variant="body">
            ...
            <section className="space-y-2">
                <Typography variant="h2" className="text-base font-bold mt-6">第3条（アカウント）</Typography>
                <Typography variant="body">
            ...
            <section className="space-y-2">
                <Typography variant="h2" className="text-base font-bold mt-6">第4条（禁止事項）</Typography>
                <Typography variant="body">ユーザーは、以下の行為を行ってはなりません。</Typography>
            ...
            <section className="space-y-2">
                <Typography variant="h2" className="text-base font-bold mt-6">第5条（ユーザー生成コンテンツ）</Typography>
                <Typography variant="body">
            ...
            <section className="space-y-2">
                <Typography variant="h2" className="text-base font-bold mt-6">第6条（免責事項）</Typography>
                <Typography variant="body">
            ...
            <section className="space-y-2">
                <Typography variant="h2" className="text-base font-bold mt-6">第7条（サービスの変更・終了）</Typography>
                <Typography variant="body">
            ...
            <section className="space-y-2">
                <Typography variant="h2" className="text-base font-bold mt-6">第8条（準拠法・管轄）</Typography>
                <Typography variant="body">
            ...
            <section className="space-y-2">
                <Typography variant="h2" className="text-base font-bold mt-6">第9条（改定）</Typography>
                <Typography variant="body">
                    運営は、必要に応じて本規約を改定することがあります。改定した場合は、本ページに掲載し、施行日を明記します。改定後の利用により、ユーザーは改定後の規約に同意したものとみなされます。
                </Typography>
                <Typography variant="caption" as="p" className="text-brand-600 mt-4">
                    制定日：2026年2月25日
                </Typography>
            </section>
        </LegalPageLayout>
