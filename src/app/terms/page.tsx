		...
		<LegalPageLayout title="利用規約">
			<section className="space-y-2">
				...
				<Typography variant="body">
					本利用規約（以下「本規約」）は、Pukapuka
					Space（ぷかぷか宇宙）（以下「本サービス」）の利用に関する条件を定めるものです。ユーザーは、本サービスを利用することにより、本規約に同意したものとみなされます。
				</Typography>
			</section>
			...
			<section className="space-y-2">
				...
				<Typography variant="body">
					本サービスの利用には、Google
					アカウントによるログインが必要です。アカウントの管理責任はユーザー本人にあり、パスワード等の漏洩による不正利用について、運営は責任を負いません。
				</Typography>
			</section>
			...
			<section className="space-y-2">
				...
				<ul className="list-disc pl-6 space-y-1 mt-2">
					...
					<li>
						<strong>不正行為</strong>
						：チートツール・マクロ・ボット等の使用、複数アカウントの作成によるポイントの不正獲得、バグを意図的に利用してポイントを稼ぐ行為、その他運営が不正と判断する行為。違反した場合、運営は事前の通知なくアカウントを即時停止し、ポイントの没収等の措置を講じることができるものとします。
					</li>
				</ul>
			</section>
