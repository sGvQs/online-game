...
const GAMES = [
	{
		...
		borderColor: "#14b8a6",
		description:
			"エラーダイアログ出現と同時に連打開始――最も多くクリックした者が7ptを掴み取り、さらにリザルトで自分の煽りコメントを敗者に叩きつけろ！",
	...
	},
	{
		...
		borderColor: "#ef4444",
		description:
			"ホストが繰り出すのは「SYSTEM SELECTION」か、それともフェイクか――その一瞬を見抜いて勝利を掴め！下のデモでは開発者と対戦できるぞ。さあ挑戦してみよう…まあ、たぶん君が負けるけどね？",
				...
				<section className={styles.gamesSection()}>
					{GAMES.map((game) => (
						<div
							...
							style={
								{
									"--game-color": game.tagColor,
									"--game-border": game.borderColor,
