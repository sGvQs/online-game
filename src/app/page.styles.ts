...
export const lpPage = tv({
	slots: {
		...
		dividerLine:
			"h-px flex-1 bg-linear-to-r from-transparent via-brand-500/40 to-transparent",
		dividerLabel: "text-[10px] tracking-[0.4em] text-brand-600 uppercase",
		dividerSub: "text-center text-[11px] text-brand-700 mt-1",
		gamesSection: "w-full max-w-5xl px-8 py-8 space-y-24",
		gameEntry: "group",
		gameBanner: "flex items-center gap-4 mb-6",
		gameNumber: "text-[80px] font-black leading-none select-none",
		gameTags: "flex gap-2 mb-2 flex-wrap",
		gameTitle: "text-4xl font-black",
		gameCard:
