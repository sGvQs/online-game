...
/** ウェーブごとのボスHP数列 */
export const ABYSS_BOSS_HP_SEQUENCE = [
	1000, 2000, 3000, 5000, 10000, 100000, 1000000, 10000000, 100000000,
	1000000000,
] as const;
/** ABYSS 解放に必要な隕石破壊数 */
...
export const SPECIAL_ATTACK_LEVEL_PARAMS: Record<
	SpecialAttackLevel,
	SpecialAttackLevelParams
> = {
