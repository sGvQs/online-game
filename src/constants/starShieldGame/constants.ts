...
// ========== 難易度・役割メタ ==========
export const DIFFICULTIES: Difficulty[] = ['EASY', 'NORMAL', 'HARD', 'HELL', 'ABYSS']

export const DIFFICULTY_META: Record<
    Difficulty,
    { label: string; rate: string; bg: string; border: string; text: string; glow: string; emoji: string }
> = {
    ...
    ABYSS: { label: 'しんえん', rate: '+5pt/波', emoji: '🌑', bg: 'rgba(15,10,30,0.6)', border: 'rgba(100,50,200,0.7)', text: '#c084fc', glow: '0 0 18px rgba(100,50,200,0.6)' },
}

export const ROLE_META: Record<
    RoleChoice,
    { iconSrc: string; label: string; description: string; detail: string; bg: string; border: string; text: string; glow: string }
> = {
    SHOOTER: {
