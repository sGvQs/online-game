...
export interface UseStarShieldLobbyReturn {
    ...
    handleGameEnd: (result: GameResult, stats: GameStats, actualDifficulty?: Difficulty) => void
    handleBackToTitle: () => Promise<void>
    handleShooterLoadoutUpdate: (updates: Parameters<typeof updateLoadout>[0]) => Promise<void>
}
