...
export function computeCollisionResult(params: {
    ...
    function applyChainDamage(astId: string, dmg: number, chainHitIds: Set<string>): void {
...
export function getContactAsteroids(params: {
    ...
    const { asteroids, now, destroyedAsteroidIds, starTargetX, starTargetY, starRadius, asteroidRadius } = params
